...
GOLDEN_DATASET = [
    {"message": "What is the weather like today?", "expected_rejected": True},
    {"message": "Can you help me write an email?", "expected_rejected": True},
    {"message": "Explain how photosynthesis works", "expected_rejected": True},
    {"message": "What are the best practices for Python coding?", "expected_rejected": True},
    {"message": "Tell me about the history of the internet", "expected_rejected": True},
    {"message": "How do I make a good cup of coffee?", "expected_rejected": True},
    {"message": "What are some healthy breakfast ideas?", "expected_rejected": True},
    {"message": "Explain machine learning in simple terms", "expected_rejected": True},
    {"message": "What's the difference between RAM and storage?", "expected_rejected": True},
    {"message": "How can I improve my writing skills?", "expected_rejected": True},
    {"message": "What are the benefits of regular exercise?", "expected_rejected": True},
